...
--
-- Хост: localhost
-- Время создания: Май 27 2015 г., 21:30
...
--
-- Структура таблицы `statistics_place`
--

CREATE TABLE IF NOT EXISTS `statistics_place` (
  `placeId` int(11) NOT NULL,
  `views` int(11) NOT NULL,
  `orders` int(11) NOT NULL,
  `corporates` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `statistics_place`
--

INSERT INTO `statistics_place` (`placeId`, `views`, `orders`, `corporates`) VALUES
(1, 6, 0, 0),
(2, 1, 0, 0),
(5, 1, 0, 0);
